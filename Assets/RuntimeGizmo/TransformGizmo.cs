...
namespace RuntimeGizmos
{
	...
	public class TransformGizmo : MonoBehaviour
	{
        ...
        public void DeleteCurrentTarget()
        {
            ...
            // Opcional: si estás usando UndoRedoManager
            if (targetRoots.ContainsKey(currentTarget))
            {
                UndoRedoManager.Insert(new RemoveTargetCommand(this, currentTarget));
            }

            // Limpiar de la lista de selección
            RemoveTargetHighlightedRenderers(currentTarget);
            RemoveTargetRoot(currentTarget);
            ...
            // Actualizar pivot si lo necesitas
            SetPivotPoint();
        }
